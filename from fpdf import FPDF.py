...
resume_data = {
    ...
    "title": "AI & IoT Engineer | Full-Stack Developer | Tech Entrepreneur",
    "contact": {
        "location": "Gaza, Palestine",
        "phone": "+972 56 714 6842",
        "email": "majdapoalnoor@gmail.com",
        "github": "github.com/majdabualnour",
        "portfolio": "portfolio-5aue.vercel.app", # Ensure this link is live and impressive!
        "linkedin": "linkedin.com/in/majd-abualnour",
        "whatsapp": "wa.me/972567146842" # Added direct link for convenience
    },
    "summary": "18-year-old visionary AI & IoT Engineer and Full-Stack Developer with 6+ years of hands-on experience building impactful tech solutions. Founder of Magic Tech MT and Dashxslash, with a proven track record driving humanitarian innovation (serving 200,000+ people) and transforming edtech (benefiting 5,000+ students). Award-winning technologist and published author, passionate about leveraging advanced technologies to solve complex real-world challenges.",
    "technical_skills": {
        "AI/ML": ["Python", "TensorFlow", "PyTorch", "OpenCV", "CNN", "RNN", "NLP", "Computer Vision"], # Removed redundant slash, added spaces
        "IoT & Embedded": ["Arduino", "Raspberry Pi", "ESP32", "Sensor Networks", "Embedded C++"],
        "Web/Mobile Development": ["Next.js", "React", "Flask", "Django", "Node.js", "JavaScript", "TypeScript"], # Clarified "Web/Mobile"
        "Database & Cloud": ["SQL", "PostgreSQL", "Firebase", "AWS", "Data Analytics"], # Corrected 'Postgress' to 'PostgreSQL', clarified "Data/Cloud"
        "DevOps & Tools": ["Docker", "CI/CD", "Linux", "Bash", "Vercel", "Git/GitHub"] # Clarified "DevOps"
    },
    "experience": [
        {
            "title": "Founder",
    ...
    "projects": [
        {
            ...
            "tech": "Python, IoT, Thermal Printing, Real-time Databases", # Clarified DB tech
            "details": [
        ...
        {
            "name": "SMART ASSIS Smart Home – Tech Talent 2022 Winner 🏆", # Emphasized award
            "tech": "CNN, RNN, IoT, Home Automation", # Consistent tech naming
            "details": [
        ...
        {
            "name": "TSC Road Safety System – Silver Medal (Sri Lanka 2022)", # Emphasized award
            "tech": "Computer Vision, Deep Learning, Sensor Integration", # More descriptive
            "details": [
        ...
        {
            "name": "Learner Guide – Palestine Hackathon Finalist 🏅", # Emphasized finalist status
            "tech": "Augmented Reality (AR), Voice Recognition, Accessibility Tools", # More descriptive
            "details": [
    ...
    "education": [
        {
            ...
            "institution": "Project-Based Learning & Online Certifications", # Broader to include certifications
            "period": "2018–Present",
            "details": [
        ...
        {
            "degree": "Computer Vision Certification",
    ...
    "achievements": [
        "Tech Talent 2022 Winner – Awarded NASA-sponsored innovation trip.",
        "Silver Medalist – Ahasak Nimavum 2022, Sri Lanka (International Competition).", # Clarified
        "Published Author – Authored 'Introduction to Computer Vision' (2024).",
        "1st Place – 7th National Exhibition Competition, Palestine.", # Reordered for impact
        "2nd Place National Level – Chess Tournament Champion." # Kept, shows well-roundedness
    ],
    "research": [
        {
            "title": "Examining the Role of Islamic Moral Gradation in Contemporary Vaccination Practices",
            "status": "Published (2025)",
            "collaborators": "Northwestern University, Harvard University Researchers", # Formalized
        ...
        },
        {
            ...
            "link": "https://academic.oup.com/sleep/article/48/Supplement_1/A581/8135182"
        },
        {
    ...
    "publications": [
        {
            ...
            "year": "2024",
            "link": "https://portfolio-5aue.vercel.app" # Assuming this links to where the book can be found/details
        }
    ],
    "languages": [
        {"name": "Arabic", "level": "Native"},
        {"name": "English", "level": "Professional Working Proficiency"} # More standard terminology
    ],
    "communities": [
        {
            "name": "TA Community Group",
            "role": "Founder & Lead Mentor", # Emphasized "Lead"
            "period": "2021-Present",
...
<body>
    <div class="header">
        ...
        <div class="contact">
            ...
            <a href="https://''' + resume_data['contact']['portfolio'].strip() + '''" target="_blank">''' + resume_data['contact']['portfolio'] + '''</a>
        </div>
    </div>
